    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><a target="_blank" href="controller/sekolah/pdf.php?id=<?php echo $key['id']; ?>">PDF</a></td>
                <td><a href="controller/sekolah/download.php?id=<?php echo $key['id']; ?>">Download</a></td>
                <td><a href="index.php?p=sekolah&m=edit&id=<?php echo $key['id']; ?>">Ubah</a></td>
                <td><a onclick="return confirm('Hapus Data<?php echo $key['nama']; ?>')" <a href="controller/sekolah/hapus.php?id=<?php echo $key['id']; ?>">Hapus</a></td>
            </tr>
        <?php
            $i++;
        } ?>
